...
import { analyzeRunSimple, SimpleBiomechanicsInput, detectErrors, getRecommendations, getFocusAreas } from '@aij/calculators';
import type { RunBiomechanicsInput } from '@aij/types';

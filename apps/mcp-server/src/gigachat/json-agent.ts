import { RunBiomechanicsInput, JsonAnalysisResult, JsonTechniqueBlock, JsonFocusBlock, JsonErrorsBlock, JsonExercisesBlock, JsonErrorItem, JsonExerciseItem, JsonMetricItem } from '@aij/types';
import { analyzeRunBiomechanics, detectErrors, getRecommendations, getFocusAreas } from '@aij/calculators';
